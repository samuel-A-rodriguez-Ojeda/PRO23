...
function setup(){
    ...
    var rotator_options={
     ...
     rotator1 = Bodies.rectangle(500,300,150,20,rotator_options);
     World.add(world,rotator1);

    rotator2 = Bodies.rectangle(100,300,150,20,rotator_options);
    World.add(world,rotator2);

    rotator3 = Bodies.rectangle(300,300,150,20,rotator_options);
